...
.PHONY: action-control-contract action-control-contract-check action-control-sandbox-contract action-control-sandbox-check ui-e2e hosted-readonly-demo hosted-readonly-demo-check hosted-readonly-demo-generate
setup:
	python3 -m venv .venv
