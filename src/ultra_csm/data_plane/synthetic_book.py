...
_ADOPTION: dict[str, tuple[int, int, int, int, float, tuple[str, ...]]] = {
    ...
    "sterling-fleet-services": (60, 76, 47, 69, 0.68, ("route_optimization",)),  # Universe v2 tier-mirror 2: shallow-adoption, high-touch
    ...
    "brookstone-supply-chain": (12, 14, 24, 32, 0.75, ("route_optimization",)),  # Universe v2 tier-mirror 2: shallow-adoption, mid-touch
    ...
    "glenbrook-distribution": (5, 8, 6, 10, 0.6, ("route_optimization",)),
    "harlow-warehousing": (3, 6, 9, 12, 0.75, ()),
    "innisfree-logistics": (7, 9, 3, 5, 0.6, ()),
    "kestrel-logistics": (4, 6, 2, 4, 0.5, ("route_optimization",)),
    ...
    "wolfden-warehousing": (2, 4, 7, 10, 0.7, ("route_optimization",)),
    "ashgate-industrial-supply": (7, 9, 8, 13, 0.62, ()),
    "bramblewood-fleet-ops": (3, 4, 8, 10, 0.8, ()),
    "copperfield2-carriers": (3, 5, 5, 9, 0.56, ("route_optimization",)),
    "duskwood-transport-co": (4, 7, 2, 3, 0.67, ("route_optimization",)),
    "evergreen-warehousing": (4, 8, 11, 14, 0.79, ("route_optimization",)),
    ...
    "pathfinder-freight": (5, 9, 9, 13, 0.69, ("route_optimization",)),
    "quailridge-line-haul": (4, 5, 3, 5, 0.6, ()),
    "ravenswood-logistics": (3, 4, 8, 10, 0.8, ()),
    "stonegate-field-services": (4, 6, 8, 12, 0.67, ()),
    "truewind-distribution": (7, 9, 3, 5, 0.6, ("route_optimization",)),
    "underpass-transport-co": (2, 4, 4, 6, 0.67, ("route_optimization",)),
    "vernonhall-delivery": (2, 4, 7, 10, 0.7, ("route_optimization",)),
    ...
    "emberfield-delivery": (4, 6, 5, 8, 0.62, ("route_optimization",)),
    "frostmoor-supply-chain": (6, 9, 4, 5, 0.8, ()),
    "graywolf-warehousing": (1, 2, 8, 12, 0.67, ()),
    "hartland-fleet-services": (1, 2, 8, 12, 0.67, ()),
    "ivorygate-freight": (5, 6, 6, 8, 0.75, ("route_optimization",)),
    "juniperfield-logistics": (2, 3, 4, 7, 0.57, ("route_optimization",)),
    ...
    "oldstone-industrial-supply": (5, 6, 6, 8, 0.75, ("route_optimization",)),
    "poplarcreek-trucking": (5, 8, 7, 10, 0.7, ("route_optimization",)),
    "quietbrook-warehousing": (5, 6, 9, 12, 0.75, ("route_optimization",)),
    ...
    "vinecrest-freight": (1, 3, 2, 3, 0.67, ("route_optimization",)),
    "watermill-trucking": (4, 5, 9, 13, 0.69, ("route_optimization",)),
    "yewbrook-field-services": (3, 4, 3, 6, 0.5, ()),
    "amberfield-fleet-ops": (7, 9, 10, 13, 0.77, ("route_optimization",)),
    ...
    "ironwood2-line-haul": (5, 7, 7, 11, 0.64, ("route_optimization",)),
    "jasperfield-logistics": (5, 7, 8, 11, 0.73, ()),
    "kettlecreek-distribution": (1, 2, 8, 12, 0.67, ("route_optimization",)),
    "lindenfield-supply-chain": (1, 2, 6, 8, 0.75, ()),
    "mossgate-logistics": (2, 3, 2, 3, 0.67, ("route_optimization",)),
    "northwind-distribution": (1, 2, 2, 4, 0.5, ()),
    "orchardview-industrial-supply": (6, 8, 4, 6, 0.67, ()),
    "palewood-field-services": (6, 9, 4, 5, 0.8, ("route_optimization",)),
    "quarrycreek-haulage": (3, 6, 3, 4, 0.75, ("route_optimization",)),
    "roughcut-freight": (3, 5, 8, 13, 0.62, ("route_optimization",)),
