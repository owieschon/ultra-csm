"""Harvest 11 robustness-grid extension: eval.fieldstone_drift_battery structural checks.
...
from eval.fieldstone_drift_battery import run_battery


def test_fieldstone_drift_battery_hard_ok_and_repeatable():
    first = run_battery()
