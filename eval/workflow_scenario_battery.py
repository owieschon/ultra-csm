...
def build_workflow_scenario_battery_artifact(
    ...
    artifact = {
        ...
        "measurement_scope": (
            ...
            "universe snapshots, then scores workflow packets with behavioral "
            "quality criteria and scenario-specific field assertions. No live "
            "connectors, LLM calls, or customer writes."
        ),
